...
$lang['f_a_sales'] = '<div style="text-align: justify;
    text-justify: inter-word;"><br>Layanan Purna jual PT Myacico Global Indonesia'
        . '<br><b>I. Bentuk Layanan Purna jual</b>'
        ...
        . 'background-repeat: no-repeat; background-size: 10px; min-width: 10px;"> Dukungan Teknis'
        . '<br><img src="'.base_url("images/general/after_sale1.png").'"'
        . 'style=" text-align: left; background-position: top left;height: 50px; '
        . 'background-repeat: no-repeat; background-size: 10px; min-width: 10px;"> Informasi suku cadang/spare part'
        . '<br><img src="'.base_url("images/general/after_sale2.png").'"'
        . 'style=" text-align: left; background-position: top left;height: 50px; '
        . 'background-repeat: no-repeat; background-size: 10px; min-width: 10px;"> Dukungan garansi resmi'
        . '<br><b>II. Jam Operasional Layanan Purna jual</b>'
        ...
        . '<br><b>III. Informasi Lokasi Layanan Purna jual</b>'
        ...
        . '<br><b>V Pembatalan Garansi/Layanan Purna jual</b>'
...
$lang['f_aftersale_bawah'] = '<img src="'.base_url("images/general/after_sale5.png").'"'
        . 'style=" text-align: left; background-position: top left;height: 650px; '
        . 'background-repeat: no-repeat; background-size: 0px; min-width: 100px;width: 100%">';
