...
<div class="container">
  <div class="row">
    ...
    <div class="col-xs-5 padding-1">
      ...
      <div style='margin-bottom:5px; margin-left:-10px; paddig-left:0px'><img src="<?php echo base_url('images/general/kak1.jpg');?>" width="100%" height="auto"></div></a>
      <a href="https://www.myacico.co.id/product/detail/1047794/CANON-Camera-PowerShot-G9X-Mark-II---Silver">
      <div style='margin-bottom:5px; margin-left:-10px; paddig-left:0px'><img src="<?php echo base_url('images/general/kak2.jpg');?>" width="100%" height="auto"></div></a>
