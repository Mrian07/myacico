...
<head>
    ...
    <!-- CSS -->
    <link href="http://localhost/newmyacico/assets/nav/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.css" rel="stylesheet">
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,700' rel='stylesheet' type='text/css'>
    <link href="http://localhost/newmyacico/assets/nav/css/animate.css" rel="stylesheet">
    <link href="http://localhost/newmyacico/assets/nav/css/bootsnav.css" rel="stylesheet">
    <link href="http://localhost/newmyacico/assets/nav/css/style.css" rel="stylesheet">
