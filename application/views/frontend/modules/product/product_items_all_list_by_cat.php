...
<div class='my-paging'>
  <?php
    if($page>1){
      $previous=$page-1;
      $first =  site_url('product/alllistItemCat/'.$uri1.'/'.$uri2.'/'.$sort_id.'/1');
      $prev =  site_url('product/alllistItemCat/'.$uri1.'/'.$uri2.'/'.$sort_id.'/'.$previous);
    ...
    for($i=$page-1;$i<$page;$i++){
      if($i<1)
        continue;
        $hal =  site_url('product/alllistItemCat/'.$uri1.'/'.$uri2.'/'.$sort_id.'/'.$i);
    ...
    //angka akhir
    $hal =  site_url('product/alllistItemCat/'.$uri1.'/'.$uri2.'/'.$sort_id.'/'.$jpage);
    ...
    if($page<$jpage){
      $next = $page+1;
      $next =  site_url('product/alllistItemCat/'.$uri1.'/'.$uri2.'/'.$sort_id.'/'.$next);
      $last =  site_url('product/alllistItemCat/'.$uri1.'/'.$uri2.'/'.$sort_id.'/'.$jpage);
...
function filter(id){
  window.location.replace("<?php echo site_url('product/alllistItemCat/'.$uri1.'/'); ?>"+id.value);
}
