			...
			<div class='detail-add-wishlist'><center>
				...
				<!-- <a href='#' onClick="addWishlist('<?php echo$m_product_id;?>','<?php echo$name;?>','<?php echo$img;?>')" class='btn btn-link'> <i class="color-wishlist fa fa-heart" style="color:#FE4365;" aria-hidden="true"></i> Add To Wishlist</a> -->
					<div class="btn-group">
						...
						<button type="button" class="btn btn-warning" onClick="addWishlist('<?php echo$m_product_id;?>','<?php echo$name;?>','<?php echo$img;?>')"><i class="color-wishlist fa fa-heart" style="color:#ffffff;" aria-hidden="true"></i> Wishlist</button>
					</div>
				</div>
			</center>
