	...
	<div class="row">
	  ...
	  <div style='width:890px; float:left'>
		...
		if($this->session->userdata('itemView')=='grid'){
			$this->load->view('frontend/modules/product/product_items_all_by_cat',$this->data);
		}else{
			$this->load->view('frontend/modules/product/product_items_all_list_by_cat',$this->data);
		}
		 ?>
	 </div>
