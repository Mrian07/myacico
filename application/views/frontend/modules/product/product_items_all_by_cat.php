...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/style_prodcut_items_all_by_cat.css');?>" />
        ...
        <div class="col-xs-3">
          <div class='tmp-product'>
            <a href="<?php echo base_url('product/detail/'.$data['m_product_id'].'/'.$data['alias']);?>">
              <img class="img-thumbnail clear-border" src="<?php echo $img_url; ?>" alt="<?php echo $data['name']; ?>" style="width: auto; max-height: 188px;" onerror="this.onerror=null;this.src='<?php echo base_url('images/general/noimage.png');?>';"/>
            </a>
...
<div class='my-paging'>
  <?php
    if($page>1){
      $previous=$page-1;
      $first =  site_url('product/alllistItemCat/'.$cat.'/'.$id.'/'.$sort_id.'/1');
      $prev =  site_url('product/alllistItemCat/'.$cat.'/'.$id.'/'.$sort_id.'/'.$previous);
    ...
    for($i=$page-1;$i<$page;$i++){
      if($i<1)
        continue;
        $hal =  site_url('product/alllistItemCat/'.$cat.'/'.$id.'/'.$sort_id.'/'.$i);
    ...
    //angka akhir
    $hal =  site_url('product/alllistItemCat/'.$cat.'/'.$id.'/'.$sort_id.'/'.$jpage);
    ...
    if($page<$jpage){
      $next = $page+1;
      $next =  site_url('product/alllistItemCat/'.$cat.'/'.$id.'/'.$sort_id.'/'.$next);
      $last =  site_url('product/alllistItemCat/'.$cat.'/'.$id.'/'.$sort_id.'/'.$jpage);
