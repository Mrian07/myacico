...
-->
  <!-- <link href="<?php echo base_url('assets/nav/css/bootstrap.css');?>" rel="stylesheet"> -->
    <link href="<?php echo base_url('assets/nav/css/style5.css');?>" rel="stylesheet">
  <!-- <link href="<?php echo base_url('assets/nav/css/font-awesome.css');?>" rel="stylesheet"> -->
<!DOCTYPE html>
<html>
<head>
			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						...
						<!-- <li><a href="kitchen.html">Kitchen1</a></li> -->
