 ...
 //    }
    ...
    <div class='row'>
      ...
      ?>
        ...
        <button type="button" style="border-radius: 25px;  padding: 8px 45px; margin-bottom:7px;"  class="btn btn-warning" onClick="addWishlist('<?php echo$data['m_product_id'];?>','<?php echo$data['name'];?>','<?php echo$img_url;?>')"><i class="fa fa-heart"  style="font-size:15px;color:grey;"  aria-hidden="true"></i> Wishlist</button>
        <?php }else{
        ?>
