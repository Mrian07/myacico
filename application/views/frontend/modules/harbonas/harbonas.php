...
background-color: #A7B5BE !important;
color: white;
background-image: url('http://1.bp.blogspot.com/-9sGdJ9zKH18/VlvOLkC20LI/AAAAAAAADdU/uUrfczLYSx4/s320/cimb%2Bniaga%2Bvector%2Blogo.png');
width: 300px;
height: 200px;
  border-radius: 15px 10px 10px 15px;
  float: left;
 ...
 <div>
  <section>
    <article class="left_article">
      ...
      C. 1 User ID dapat menggunakan kode voucher maksimum 1x (satu kali) dengan pembelian maksimum 3 pcs untuk setiap SKU (kode) produk per transaksi.<br/>
