...
.brace {
  ...
  background-image: -webkit-radial-gradient(circle at 0 0, rgba(255,255,255,0) 14.5px, red 15.5px, red 19.5px, rgba(255,255,255,0) 20.5px), -webkit-radial-gradient(circle at 35px 0, rgba(255,255,255,0) 14.5px, red 15.5px, red 19.5px, rgba(255,255,255,0) 20.5px);
  background-image: -webkit-radial-gradient(0 0 circle, rgba(255,255,255,0) 14.5px, red 15.5px, red 19.5px, rgba(255,255,255,0) 20.5px), -webkit-radial-gradient(35px 0 circle, rgba(255,255,255,0) 14.5px, red 15.5px, red 19.5px, rgba(255,255,255,0) 20.5px);
  background-image: radial-gradient(circle at 0 0, rgba(255,255,255,0) 14.5px, red 15.5px, red 19.5px, rgba(255,255,255,0) 20.5px), radial-gradient(circle at 35px 0, rgba(255,255,255,0) 14.5px, red 15.5px, red 19.5px, rgba(255,255,255,0) 20.5px);
