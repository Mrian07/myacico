...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Myacico - <?php echo $title_page; ?></title>
		...
		<!-- s: style lalang -->
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/style_backend.css');?>" />
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/animate.css');?>" />
		<!--<link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url('images/favicon/'.$favicon);?>">-->
		<!-- e: style lalang -->
